      ...
      <>
        <div className="flex items-center px-5 py-4 gap-4">
          <Input
              ...
              className="flex-1 bg-gray-200 border-none ring-0 shadow-none h-10"
        ...
        <div
            className="custom-scrollbar max-h-[60vh] overflow-y-auto border-t border-gray-300 px-2 py-4">
          <>
                ...
                <Fragment key={item.name + '-' + index}>
                  ...
                  <span
                    ...
                    <span className="text-gray-500">
                      ...
                      <h6
                          className={cn(
                              'mb-1 px-3 text-xs font-semibold uppercase text-left tracking-widest text-gray-500 dark:text-gray-500',
