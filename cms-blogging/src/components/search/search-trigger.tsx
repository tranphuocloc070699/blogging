import {Command, Glasses, Search} from "lucide-react";
  ...
  return (
      ...
      >
        {icon ? (
            ...
            <Search className="magnifying-glass me-2 h-[18px] w-[18px]"/>
        )}
        <span
            className={cn(
        ...
        <span
            className="search-command ml-auto hidden items-center text-sm text-gray-600 lg:flex lg:rounded-md lg:bg-primary lg:px-1.5 lg:py-1 lg:text-xs lg:font-semibold lg:text-primary-foreground xl:justify-normal">
