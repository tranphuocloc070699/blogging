      ...
      <div
        ...
        <NotificationsDropdown>
          ...
          >
            ...
            <Badge
                renderAsDot
                className="absolute right-2.5 top-2.5 -translate-y-1/3 translate-x-1/2 bg-amber-600"
        ...
        <MessagesDropdown>
          ...
          >
            ...
            <Badge
                renderAsDot
                className="absolute right-2.5 top-2.5 -translate-y-1/3 translate-x-1/2 bg-green-600"
