...
export const taxonomyFormParts = {
  basicInfo: 'basicInfo',
};

export const taxonomyMenuItems = [
  {
    label: 'Basic Information',
    value: taxonomyFormParts.basicInfo,
  },
];

interface TaxonomyFormNavProps {
  className?: string;
}

export default function TaxonomyFormNav({className}: TaxonomyFormNavProps) {
  return (
      <div
          className={cn(
