...
export default function NovelEditorWrapper({ value, onChange, className }: NovelEditorWrapperProps) {
    ...
    <div className={cn("w-full", className)}>
      ...
      <EditorRoot key={editorKey}>
        <EditorContent
          ...
          editorProps={{
            attributes: {
              class: 'prose prose-lg dark:prose-invert focus:outline-none max-w-full min-h-full px-0 py-4'
            },
            handleDOMEvents: {
