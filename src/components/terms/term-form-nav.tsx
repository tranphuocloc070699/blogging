...
export const termFormParts = {
  basicInfo: 'basicInfo',
};

export const termMenuItems = [
  {
    label: 'Basic Information',
    value: termFormParts.basicInfo,
  },
];

interface TermFormNavProps {
  className?: string;
}

export default function TermFormNav({className}: TermFormNavProps) {
  return (
      <div
          className={cn(
