...
const BlogPostItem = ({ post }: BlogPostItemProps) => {
        ...
        // Hard-coded data for UI (as requested)
        // const viewCount = 123;
        const isRead = false; // Change to true to show "read" badge

        return (
                <Link href={`/posts/${post.slug}`} className="block group">
                        {/* Responsive: vertical on mobile (flex-col), horizontal on desktop (md:flex-row) */}
