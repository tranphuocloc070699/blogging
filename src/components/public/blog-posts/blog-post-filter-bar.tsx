  ...
  return (
    <div className="mb-10">
      ...
      <div className="hidden md:flex items-center gap-4 justify-between">
        ...
        <div
          className={`transition-all duration-300 ${isMobileSearchOpen ? "w-0 opacity-0" : "flex-1 max-w-[220px]"}`}
        >
          <Select
      ...
      <div className="md:hidden h-[40px]">
        <div className="flex items-center gap-2 justify-between">
          ...
          {/* Search - Animated */}
          <div
            className={`transition-all duration-300 ${isMobileSearchOpen ? "flex-1" : "w-auto"}`}
          >
            {isMobileSearchOpen ? (
