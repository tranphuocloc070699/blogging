				...
				<Popover
												...
												return (
													<Badge
														...
														<div
															...
															className="ml-2 w-4 cursor-pointer hover:bg-white/20 rounded-sm p-0.5 -m-0.5 focus:outline-none focus:ring-1 focus:ring-white/50">
															<XCircle
																className={cn(
																	"h-3 w-3",
																	responsiveSettings.compactMode &&
					...
					<PopoverContent
						...
						<Command>
							...
							<CommandList
								className={cn(
									"max-h-[300px] overflow-y-scroll multiselect-scrollbar",
