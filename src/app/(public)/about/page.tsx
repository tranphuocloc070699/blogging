            ...
            <div className="text-base md:text-lg text-gray-600 leading-relaxed space-y-4">
              <div>
                ...
                <ShinyText
                  ...
                  className="font-semibold text-xl"
                />
                . I&apos;m a frontend developer with a deep enthusiasm for
                technology, philosophy, and the curiosities of the world.
              </div>
              <p>
                I enjoy exploring new ideas and sharing what I learn, hoping it
                can make your journey a little easier than mine.
              </p>
            </div>
          </div>
        </div>
